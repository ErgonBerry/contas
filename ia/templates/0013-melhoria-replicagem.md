...
fazer melhoria quando pressiona card de income e ou expense abre janela para replicá-lo. que quero adicione uma animação no card quando ele for pressionado e fazer uma contagem regressiva de 3 segundos até abrir a janela de replicar.
