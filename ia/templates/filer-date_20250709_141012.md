...
filer-date - eu gostaria de adicionar uma funcionalidade apenas na rota do /income. gostaria de adicionar um filtro (com um botao inteligente de slide, moderno) para filtrar por data. um slice que eu posso puxar da direita e da esquerda, diminuindo ou aumentando o filtro em dias , apenas em dias, nao precisa ser um filtro entre meses, pois a rota do /income ja ja está filtrado por mes.
