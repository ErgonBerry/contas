...
🔍 OBJETIVO DA TAREFA:
Remover os cards de transações recentes e debug da página de Resumo Financeiro. E na página de config, na exibição da versao, usar a versão do package.json
